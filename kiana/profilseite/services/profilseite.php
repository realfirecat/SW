<?php
   ...
   */
    $qry3 = "select CONCAT(fk_pk_jahrgang, fk_pk_buchstabe, fk_pk_fk_pk_kuerzel) from benutzer
          where vorname like 'angela' and nachname like 'amacna';";
    $ary3 = array();
...
<nav>
    <md-whiteframe layout="row" id="profilseite_nav-whiteframe" class="md-whiteframe-10dp" layout-align="space-between center">
        
        <img id="profilseite_logo" src="htl3r_logo_transp_gross.png">
        <md-button class="md-raised" id="profilseite_abmelden">Abmelden</md-button>
